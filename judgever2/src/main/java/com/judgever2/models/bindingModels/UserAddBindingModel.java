...
public class UserAddBindingModel {
    ...
    @Length(min = 3, max = 10, message = "Username must be between 2 and 10 characters")
    ...
    @Length(min = 3, max = 10, message = "Confirm password must be between 3 and 10 characters")
    ...
    @NotNull(message = "Enter github address!")
